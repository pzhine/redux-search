!function(root, factory) {
    ...
    function(module, exports) {
        ...
        function(module, exports, __webpack_require__) {
            ...
            Object.defineProperty(exports, "__esModule", {
                value: !0
            }), exports.SearchApi = exports.INDEX_MODES = void 0;
            var _SearchApi = __webpack_require__(2), _SearchApi2 = _interopRequireDefault(_SearchApi), _util = __webpack_require__(3);
            exports.INDEX_MODES = _util.INDEX_MODES, exports.SearchApi = _SearchApi2.default, 
        ...
        function(module, exports, __webpack_require__) {
            ...
            function _inspect(input, depth) {
                var maxDepth = 4, maxKeys = 15;
                if (void 0 === depth && (depth = 0), depth += 1, null === input) return "null";
                ...
                if (Array.isArray(input)) {
                    if (input.length > 0) {
                        ...
                        }) ? first.trim() + "[]" : "[" + input.slice(0, maxKeys).map(function(item) {
            ...
            }(), _util = __webpack_require__(3), _util2 = _interopRequireDefault(_util), _worker = __webpack_require__(7), _worker2 = _interopRequireDefault(_worker), SearchApi = function() {
                function SearchApi() {
                    var _ref3 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, indexMode = _ref3.indexMode, tokenizePattern = _ref3.tokenizePattern, caseSensitive = _ref3.caseSensitive;
        ...
        function(module, exports, __webpack_require__) {
            ...
            exports.INDEX_MODES = _constants.INDEX_MODES, exports.SearchUtility = _SearchUtility2.default, 
        ...
        function(module, exports, __webpack_require__) {
		   ...
		   */
                function SearchUtility() {
                    var _ref14 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, _ref14$indexMode = _ref14.indexMode, indexMode = void 0 === _ref14$indexMode ? _constants.INDEX_MODES.ALL_SUBSTRINGS : _ref14$indexMode, _ref14$tokenizePatter = _ref14.tokenizePattern, tokenizePattern = void 0 === _ref14$tokenizePatter ? /\s+/ : _ref14$tokenizePatter, _ref14$caseSensitive = _ref14.caseSensitive, caseSensitive = void 0 !== _ref14$caseSensitive && _ref14$caseSensitive;
                    _classCallCheck(this, SearchUtility), this._indexMode = indexMode, this._tokenizePattern = tokenizePattern, 
                    this._caseSensitive = caseSensitive, this.searchIndex = new _SearchIndex2.default(), 
                    this.uids = {};
                }
                /**
		   ...
		   */
                return _createClass(SearchUtility, [ {
                    ...
                    value: function() {
                        function _ref2(_id2) {
                            if (!(_id2 instanceof RegExp)) throw new TypeError("Function return value violates contract.\n\nExpected:\nRegExp\n\nGot:\n" + _inspect(_id2));
                            return _id2;
                        }
                    ...
                    value: function() {
                        function _ref3(_id3) {
                            if ("boolean" != typeof _id3) throw new TypeError("Function return value violates contract.\n\nExpected:\nboolean\n\nGot:\n" + _inspect(_id3));
                            return _id3;
                        }
                    ...
                    value: function(uid, text) {
                        function _ref4(_id4) {
                            if (!(_id4 instanceof SearchUtility)) throw new TypeError("Function return value violates contract.\n\nExpected:\nSearchUtility\n\nGot:\n" + _inspect(_id4));
                            return _id4;
                        }
                        var _this = this;
                        if ("string" != typeof text) throw new TypeError('Value of argument "text" violates contract.\n\nExpected:\nstring\n\nGot:\n' + _inspect(text));
                    ...
                    value: function(query) {
                        function _ref5(_id5) {
                            if (!Array.isArray(_id5)) throw new TypeError("Function return value violates contract.\n\nExpected:\nArray<any>\n\nGot:\n" + _inspect(_id5));
                            return _id5;
                        }
                        if ("string" != typeof query) throw new TypeError('Value of argument "query" violates contract.\n\nExpected:\nstring\n\nGot:\n' + _inspect(query));
                        if (query) {
                    ...
                    value: function(pattern) {
                        if (!(pattern instanceof RegExp)) throw new TypeError('Value of argument "pattern" violates contract.\n\nExpected:\nRegExp\n\nGot:\n' + _inspect(pattern));
                        this._tokenizePattern = pattern;
                    }
                }, {
                    key: "setCaseSensitive",
                    value: function(caseSensitive) {
                        if ("boolean" != typeof caseSensitive) throw new TypeError('Value of argument "caseSensitive" violates contract.\n\nExpected:\nboolean\n\nGot:\n' + _inspect(caseSensitive));
                    ...
                    value: function(string) {
                        function _ref12(_id12) {
                            if ("string" != typeof _id12) throw new TypeError("Function return value violates contract.\n\nExpected:\nstring\n\nGot:\n" + _inspect(_id12));
                            return _id12;
                        }
        ...
        function(module, exports, __webpack_require__) {
		   ...
		   */
                function SearchWorkerLoader() {
                    var _this = this, _ref3 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {}, indexMode = _ref3.indexMode, tokenizePattern = _ref3.tokenizePattern, caseSensitive = _ref3.caseSensitive, WorkerClass = _ref3.WorkerClass;
                    ...
                    WorkerClass || (// eslint-disable-next-line
                    WorkerClass = __webpack_require__(11)), // Maintain context if references are passed around
	...
	*/
	 ...
	 */
            function combineReducers(reducers) {
                ...
                var finalReducerKeys = Object.keys(finalReducers), unexpectedKeyCache = void 0;
